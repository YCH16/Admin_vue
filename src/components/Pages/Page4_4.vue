<template>
  ...
  <el-card class="box-card1">
    <el-breadcrumb :separator-icon="ArrowRight">
      ...
      <el-breadcrumb-item>添加简答题</el-breadcrumb-item>
    </el-breadcrumb>
  </el-card>

  <el-card class="box-card1">
    <h2 align="center">添加简答题</h2>
      <el-form  :model="form">
        <h4>专业方向:</h4>
        <el-select v-model="form.mname"  placeholder="Select">
          <el-option
...
export default {
  ...
  methods:{
    Browser(){
      ...
      this.message_Answer='参考答案: '+this.form.answer;
    },
    reset(){
      this.form={}
    },
